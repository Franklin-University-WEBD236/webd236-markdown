        ...
        <form action="/process/contact" method="post">
          <div class="form-row">
            <div class="col">
              ...
              <input type="text" class="form-control" id="name" name="form[name]" placeholder="Enter your name" required value=<?php echo(htmlentities(value($form['name']))); ?>>
            </div>
            <div class="col">
              <label for="email3">Email address</label>
              <input type="email" class="form-control" id="email3" name="form[email]" placeholder="Enter email address" required value=<?php echo(htmlentities(value($form['email']))); ?>>
            </div>
          </div>
          <div class="form-row mt-2">
            <div class="col">
              <label for="subject">Subject</label>
              <input type="text" class="form-control" id="subject" name="form[subject]" placeholder="Enter subject" required value=<?php echo(htmlentities(value($form['subject']))); ?>>
            </div>
          </div>
